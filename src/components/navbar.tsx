...
function Navbar(){
    return (            <nav className="gap-2 pt-2 flex flex-row items-center justify-between w-full h-[70px]">
        ...
        <Link
            className="flex flex-row items-center px-2 gap-2
                    rounded-[200px] p-2 hover:text-blue-500
                    transition-colors duration-400 ease-in-out mr-2"
            href="/login"
        >
            <h1>Войти</h1>
            <LogIn />
